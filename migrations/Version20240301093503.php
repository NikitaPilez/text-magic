 ...
 */
final class Version20240301093503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT NOT NULL, question_id INT NOT NULL, option VARCHAR(255) NOT NULL, correct BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE result (id INT NOT NULL, quiz_id INT NOT NULL, question_id INT NOT NULL, correct BOOLEAN NOT NULL, PRIMARY KEY(id))');
